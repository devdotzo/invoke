...
export function FooterSection() {
  return (
    <footer
      id="github"
      className="bg-ink px-6 py-20 text-white md:px-12 lg:px-20"
    >
        ...
        <div className="grid gap-10 border-b border-white/10 pb-16 lg:grid-cols-[1fr_0.75fr] lg:items-end">
          <div>
            ...
            <h2 className="max-w-3xl text-white">
              Your voice command layer for work.
            </h2>
            <p className="mt-6 max-w-2xl text-lg text-white/68">
              Invoke is built for people who want voice to do more than dictate.
              Explore the code, follow development, and try the project from
              GitHub.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
            ...
            <a
              href="#how-it-works"
              className="cta-secondary cta-secondary-dark"
            >
              See how it works
            </a>
          </div>
