    ...
    <section className="hero-shell relative min-h-screen overflow-hidden">
      ...
      <header className="hero-nav relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 md:px-10 lg:px-12">
        <a href="#" className="flex items-center gap-3">
          ...
          <span className="font-mono text-sm uppercase tracking-[0.24em] text-white">
            Invoke
          </span>
        </a>
        ...
        <a
          href="https://github.com/devdotzo/Invoke"
          target="_blank"
          rel="noopener noreferrer"
          className="hidden items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium text-primary transition-transform hover:-translate-y-0.5 md:inline-flex"
        >
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-88px)] w-full max-w-7xl gap-12 px-6 pb-16 pt-10 md:px-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-12">
        <div>
          ...
          <p className="hero-copy mt-8 max-w-2xl text-xl leading-relaxed text-white/78 md:text-2xl">
            Turn speech into messages, notes, snippets, searches, and app
            actions. Use local AI through Ollama, connect tools through
            Composio, and keep control of your data with privacy-first setup.
          </p>
          ...
          <div className="space-y-3">
            {commandRail.map((item, index) => (
              <div
                ...
                style={
                  { "--card-delay": `${760 + index * 120}ms` } as CSSProperties
                }
              >
                <p>"{item.speech}"</p>
      ...
      <a
        href="#problem"
        className="absolute bottom-7 left-1/2 z-10 -translate-x-1/2 animate-bounce text-white/45"
      >
